...
<head>
    ...
    <script>
        ...
        function refreshCode() {
            ...
            //2.设置其src属性，加上时间戳
            vcode.src = "${pageContext.request.contextPath}/login/checkCode?name=ADMIN&time="+new Date().getTime();
        }
...
<div class="main-wrapper" >
    ...
    <div style="background-color: #023B68">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="${pageContext.request.contextPath}/driverLogin2.jsp" style="color: white;font-family: 楷体;text-decoration: none;font-size: large">司机登录</a>
    </div>
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark" style="background: url(${pageContext.request.contextPath}/static/img/banner.jpg) no-repeat;">
        <div class="auth-box bg-dark border-top border-secondary" >
            <div class="box-head" style="border-bottom: 1px solid #e0e0e0;overflow: hidden;  width:360px;height:80px;line-height:50px; ">
                ...
                <h3 style="font-size:20px;display: block;height: 80px;line-height:50px;text-align: center">管理员登录</h3>
            </div>
            <div>
                <!-- Form -->
                <form class="form-horizontal m-t-20" id="loginform" action="${pageContext.request.contextPath}/login/adminLoginRequest" method="post" style="border: 0px">
                    <div class="row p-b-30">
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" name="adminName" placeholder="用户名" aria-label="Username" aria-describedby="basic-addon1" required="" style="border: none;">
                            </div>
                            <div class="input-group mb-3">
                                <!-- <div class="input-group-prepend">
                                ...
                                <input type="text" class="form-control form-control-lg" name="adminPassword" placeholder="密码" aria-label="Password" aria-describedby="   basic-addon1" required="" style="border: none;">
                            </div>
                            <div class="input-group mb-3">
                                <!-- <div class="input-group-prepend">
                                    <span class="input-group-text bg-success text-white"    id="basic-addon1"><i class="ti-user"></i></span>
                                ...
                                <a href="javascript:refreshCode();">
                                    <img src="${pageContext.request.contextPath}/login/checkCode?name=ADMIN" title="看不清点击刷新" id="vcode"/>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <c:if test="${adminError!=null}">
                    ...
                    <div class="alert alert-info alert-dismissible" role="alert">
                        ...
                        <strong style="color: red" >${adminError}</strong>
                    </div>
                </c:if>
            </div>
